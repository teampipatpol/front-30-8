<template>
    ...
    <div class="cart-item-details">
      ...
      <button class="remove-item-btn" @click="removeFromCart(item._id)">
        <i class="fas fa-times"></i> <!-- Cross icon using Font Awesome -->
      </button>
    </div>
  </li>
          ...
          <v-card-actions>
            <v-spacer></v-spacer>
            <v-btn color="green darken-1" text @click="sellProducts">ซื้อ</v-btn>
            <v-btn color="grey darken-1" text @click="toggleCart">ปิด</v-btn>
          </v-card-actions>
        </v-card>
      </v-dialog>
    </div>
